...
noble.on('discover', function(peripheral) {
    ...
    peripheral.connect(function(err){
    	 ...
    	 peripheral.discoverServices(['ffb0'], function(error, services) {
    	 	var service = services[0];
    	 	service.discoverCharacteristics(['ffb2'], function(error, characteristics) {
